...
schema_view = get_schema_view(
    openapi.Info(
        ...
        terms_of_service="",
        contact=openapi.Contact(email="suxrobeergashev2102@gamil.com"),
        license=openapi.License(name="https://t.me/uztechaward/11013"),
    ),
    public=True,
...
urlpatterns = [
    ...
    path('api/v1/', include("xakaton_api.urls")),
